...
local poweroff_command = function()
  awful.spawn.with_shell("sudo power.sh shutdown")
  awful.keygrabber.stop(exit_screen_grabber)
end
local reboot_command = function()
  awful.spawn.with_shell("sudo power.sh reboot")
  awful.keygrabber.stop(exit_screen_grabber)
end
local suspend_command = function()
  awful.spawn.with_shell("sudo power.sh suspend")
...
-- Capitalize username
local goodbye_widget = wibox.widget.textbox("goodbye " .. username)
...
local poweroff_text = wibox.widget.textbox("Shutdown")
