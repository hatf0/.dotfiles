...
floating_terminal = "alacritty --class fst" -- clients with class "fst" are set to be floating (check awful.rules below)
browser = "firefox"
filemanager = "nemo"
...
mymainmenu = awful.menu({ items = {
    ...
    function ()
        local matcher = function (c)
            return awful.rules.match(c, {class = 'Ripcord'})
        end
        awful.client.run_or_raise("ripcord", matcher)
    end,
